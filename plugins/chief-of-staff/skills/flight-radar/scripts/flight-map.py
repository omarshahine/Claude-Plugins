...
Usage:
    ...
    echo '{"registration":"N12345","latitude":37.1,...}' | python3 flight-map.py --stdin
    echo '{"registration":"N12345",...}' | python3 flight-map.py --stdin --output map.html
    echo '{"registration":"N12345",...}' | python3 flight-map.py --stdin --no-open
"""
import argparse
import json
import os
